...
public class BlockEntityModelGetterImpl implements DataDrivenModelEvents.FinalizeBlockEntityModels.ModelGetter {
	...
	private final Map<Identifier, SimpleBlockEntityModel<? extends BlockEntityRenderState>> models;

	public BlockEntityModelGetterImpl(Map<Identifier, SimpleBlockEntityModel<? extends BlockEntityRenderState>> models) {
		this.models = models;
	}
	...
	public <S extends BlockEntityRenderState> SimpleBlockEntityModel<S> getModel(Identifier identifier) {
		if (!this.models.containsKey(identifier)) throw new IllegalArgumentException("Missing data-driven block entity model: " + identifier);
