...
public class CustomWaterloggedVegetationPatchFeature implements CustomFeature, FeatureRegistrable {
	...
	public CustomWaterloggedVegetationPatchFeature(int count, Direction searchDirection, int maxSteps, TagKey<Block> replaceable, BlockState ground, BiList<BlockState, Integer> vegetationStates, VerticalSurfaceType verticalSurfaceType, IntProvider depth, float extraBottomBlockChance, int verticalRange, float vegetationChance, IntProvider horizontalRadius, float extraEdgeColumnChance) {
		this.count = count;
	...
	public CustomWaterloggedVegetationPatchFeature addPlacedFeature(int count, Direction searchDirection, int maxSteps, String idExt) {
