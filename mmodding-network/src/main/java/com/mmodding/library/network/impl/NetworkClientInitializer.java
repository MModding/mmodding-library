...
public class NetworkClientInitializer implements ClientModInitializer {
	...
	public void onInitializeClient() {
		ClientPlayNetworking.registerGlobalReceiver(DelayedNetworkPackets.ResponsePayload.TYPE, (packet, context) -> {
		...
		ClientPlayNetworking.registerGlobalReceiver(DelayedNetworkPackets.RequestPayload.TYPE, (packet, context) -> {
			...
			ClientPlayNetworking.send(new DelayedNetworkPackets.ResponsePayload(packet.requestTracker(), arguments));
		});
	}
}
