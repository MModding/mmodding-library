...
@ApiStatus.Internal
public class ItemModelHandler implements DataProcessHandler<Item, ItemModelProcessor> {
	...
	private static class AutomatedModelProvider extends FabricModelProvider {
		...
		public AutomatedModelProvider(BiList<ItemModelProcessor, List<Item>> contentToProcess, FabricPackOutput output) {
			super(output);
